...
export default {
  ...
  typesVector: {
    ...
    fighting: new Vector3(0.82, 0.29, 0.25),
    flying: new Vector3(0.7, 0.62, 250),
    poison: new Vector3(0.73, 0.36, 0.73),
    ground: new Vector3(0.94, 0.82, 0.47),
    rock: new Vector3(0.82, 0.72, 0.33),
    bug: new Vector3(0.76, 0.82, 0.25),
    ghost: new Vector3(0.54, 0.44, 0.69),
    steel: new Vector3(0.76, 0.76, 0.86),
    fire: new Vector3(1, 0.59, 0.3),
    water: new Vector3(0.47, 0.63, 1),
    grass: new Vector3(0.56, 0.86, 0.4),
    electric: new Vector3(1, 0.87, 0.31),
    psychic: new Vector3(0.99, 0.44, 0.6),
    ice: new Vector3(0.6, 0.85, 0.85),
    dragon: new Vector3(0.44, 0.22, 0.98),
    fairy: new Vector3(0.98, 0.64, 0.72),
    unkown: new Vector3(0.69, 0.73, 0.72),
    dark: new Vector3(0.56, 0.47, 0.4),
  },
};
